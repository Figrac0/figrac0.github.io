...
var slider = (0,tiny_slider__WEBPACK_IMPORTED_MODULE_0__.tns)({
  ...
  autoplay: true,
  speed: 800,
  // Устанавливаем скорость анимации в миллисекундах
  autoplayTimeout: 3000,
  // Время между автопереключениями
  autoplayButtonOutput: false,
  // Скрыть кнопку автоплей
  prevButton: document.getElementById('customPrev'),
  // Кастомная кнопка "prev"
  nextButton: document.getElementById('customNext'),
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  dateInput.addEventListener("click", function () {
    if (this.type !== 'date') {
      ...
      this.focus();
      this.blur();
      this.focus(); // Открываем календарь
    }
  });
  dateInput.addEventListener("blur", function () {
    if (this.value === '') {
      this.type = 'text';
      this.placeholder = 'Дата аренды'; // Восстанавливаем placeholder если поле пустое
    }
  });
});
/******/ })()
